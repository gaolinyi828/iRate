...
public class iRate_query {
     ...
     */
    public static void averageRating(Statement stmt, int movieId) throws SQLException{
     ...
     * @throws SQLException SQLException
     */
    public static void averageRatingsAll(Statement stmt) throws SQLException {
     ...
     * @throws SQLException SQLException
     */
    public static void endorsement(Statement stmt, int reviewId) throws SQLException{
     ...
     * @throws SQLException SQLException
     */
    public static void endorsementsAll(Statement stmt) throws SQLException{
     ...
     * @throws SQLException SQLException
     */
    public static void reviewsOfMovie(Statement stmt, int movieId) throws SQLException{
        String title = null;
     ...
     * @throws  SQLException SQLException
     */
    public static void movieWatched(Statement stmt, int CustomerId) throws SQLException{
        ResultSet rs = stmt.executeQuery(
     ...
     * @throws SQLException SQLException
     */
    public static void ReviewWrote(Statement stmt, int CustomerId) throws SQLException{
     ...
     * @throws SQLException SQLException
     */
    public static void ReviewEndorsed(Statement stmt, int CustomerId) throws SQLException{
     ...
     * @throws SQLException SQLException
     */
    public static void CustomerEndorsingOnAGivenDay(Statement stmt, Date date) throws SQLException {
